...
if param_set == 'Data1':
	...
	Tstar = Tstar_1
	Rstar = Rstar_1
	temp = ['434','449','465','480','495','511','526','541','557','572']

elif param_set == 'Data2':
	Pstar = Pstar_2
	Tstar = Tstar_2
	Rstar = Rstar_2
	temp = ['424','444','464','484','503','524','544','564','584','603']

elif param_set == 'Data3':
	Pstar = Pstar_3
	Tstar = Tstar_3
	Rstar = Rstar_3
	temp = ['433','443','453','463','473','483','493','503','513','523','533','543','553','563','573','583','593']

elif param_set == 'Data4':
	Pstar = Pstar_4
	Tstar = Tstar_4
	Rstar = Rstar_4
	temp = ['424','434','444','454','464','474','484','494','504','514','524','534','544','554','564']
